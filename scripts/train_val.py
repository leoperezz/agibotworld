from agibot.configs.train import TrainPipelineConfigAgiBot
from agibot.train.trainer import Trainer
from accelerate import Accelerator
from lerobot.configs import parser

@parser.wrap()
def train(cfg: TrainPipelineConfigAgiBot, accelerator: Accelerator | None = None):
    """
